                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <!-- <InputError :message="errors.price">{{ errors.price }}</InputError> -->
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="is_selling" class="leading-7 text-sm text-gray-600 mr-2">status</label>
                                                    <!-- <InputError :message="errors.price">{{ errors.price }}</InputError> -->
                                                    <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" >
                                                    <label class="ml-1 mr-1">販売中</label>
                                                    <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="0" class="ml-1">
