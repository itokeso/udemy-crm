                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.name">{{ errors.name }}</InputError>
                                                    <input type="text" id="name" name="name" v-model="form.name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="kana" class="leading-7 text-sm text-gray-600">NameKana</label>
                                                    <InputError :message="errors.kana">{{ errors.kana }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.tel">{{ errors.tel }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.email">{{ errors.email }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.postcode">{{ errors.postcode }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <InputError :message="errors.address">{{ errors.address }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="birthday" class="leading-7 text-sm text-gray-600">Birthdat</label>
                                                    <InputError :message="errors.birthday">{{ errors.birthday }}</InputError>
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="is_selling" class="leading-7 text-sm text-gray-600 mr-2">Gender</label>
                                                    <InputError :message="errors.gender">{{ errors.gender }}</InputError>
                                                    <input type="radio" id="gender0" name="gender" v-model="form.gender" value="0" >
                                                    <label for="gender0" class="ml-1 mr-1">男性</label>
                                                    <input type="radio" id="gender1" name="gender" v-model="form.gender" value="1" class="ml-1">
                                                    <label for="gender1" class="leading-7 text-sm text-gray-600">女性</label>
                                                    <input type="radio" id="gender2" name="gender" v-model="form.gender" value="2" class="ml-1">
                                                    <label for="gender2" class="leading-7 text-sm text-gray-600">その他</label>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="memo" class="leading-7 text-sm text-gray-600">Memo</label>
                                                    <InputError :message="errors.memo">{{ errors.memo }}</InputError>
